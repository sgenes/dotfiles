let g:airline#themes#MoonMaster#palette = {}
  ...
  " Normal Mode:
  let s:N1 = [ '#2f343f' , '#ffffff' , 0 , 8 ] " Mode
  let s:N2 = [ '#2f343f' , '#5294e2' , 0 , 12  ] " Info
  let s:N3 = [ '#ffffff' , '#2f343f' , 8 , 0  ] " StatusLine
  ...
  let g:airline#themes#MoonMaster#palette.normal_modified = {
        \ 'airline_c': [ '#fac536' , '#2f343f' , 11 , 0 , '' ] ,
        \ 'airline_warning': [ '#2f343f' , '#fac536' , 0 , 11 , '' ] ,
        \ 'airline_error': [ '#ffffff' , '#990000' , 8 , 140 , '' ] ,
        \ }


  " Insert Mode:
  let s:I1 = [ '#2f343f' , '#ffffff' , 0 , 8 ] " Mode
  let s:I2 = [ '#2f343f' , '#5294e2' , 0 , 12 ] " Info
  let s:I3 = [ '#ffffff' , '#2f343f' , 8 , 0 ] " StatusLine


  let g:airline#themes#MoonMaster#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
  let g:airline#themes#MoonMaster#palette.insert.airline_warning = [ '#2f343f' , '#fac536' , 0 , 11 ]
  ...
  let g:airline#themes#MoonMaster#palette.insert_modified = {
        \ 'airline_c': [ '#fac536' , '#2f343f' , 11 , 0 , '' ] ,
        \ 'airline_warning': [ '#2f343f' , '#fac536' , 0 , 11 , '' ] ,
        \ 'airline_error': [ '#ffffff' , '#990000' , 0 , 140 , '' ] ,
        \ }


  " Replace Mode:
  let g:airline#themes#MoonMaster#palette.replace = copy(g:airline#themes#MoonMaster#palette.insert)
  let g:airline#themes#MoonMaster#palette.replace.airline_a = [ '#f25056' , '#ffffff' , 9 , 8 , ''     ]
  let g:airline#themes#MoonMaster#palette.replace.airline_warning = [ '#2f343f' , '#fac536' , 0 , 11 ]
  ...
  " Visual Mode:
  let s:V1 = [ '#2f343f', '#ffffff', 0, 8 ]
  let s:V2 = [ '#2f343f', '#5294e2', 0,  12 ]
  let s:V3 = [ '#ffffff', '#2f343f', 8 , 0  ]

  let g:airline#themes#MoonMaster#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
  let g:airline#themes#MoonMaster#palette.visual.airline_warning = [ '#2f343f' , '#fac536' , 0 , 11 ]
  ...
  " Inactive:
  let s:IA1 = [ '#2f343f' , '#ffffff' , 0 , 8 , '' ]
  let s:IA2 = [ '#ffffff' , '#454c5c' , 12 , 0 , '' ]
  let s:IA3 = [ '#ffffff' , '#2f343f' , 15 , 0 , '' ]
  let g:airline#themes#MoonMaster#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
  let g:airline#themes#MoonMaster#palette.inactive.airline_warning = [ '#2f343f' , '#fac536' , 0 , 11 ]
